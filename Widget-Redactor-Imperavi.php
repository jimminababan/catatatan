...
class FileHelper extends BaseFileHelper
{
     ...
     * }
     */
    public static function findFiles($imageurl, $dir, $options = [], $type = GetAction::TYPE_IMAGES)
    {
        if (!is_dir($dir)) {
                ...
                if (is_file($path)) {
                    if (isset($options['url'])) {
                        if ($type === GetAction::TYPE_IMAGES) {
                            ...
                            $list[] = [
                                'thumb' => $imageurl.DIRECTORY_SEPARATOR.$file,
                                'image' => $imageurl.DIRECTORY_SEPARATOR.$file,
                                'title' => $file,
                            ];
